...
register.addEventListener("click", function (e) {
  ...
  if (isFormValid) {
    window.open("http://127.0.0.1:5503/dash%20board/Dashboard.html#");
    window.close("http://127.0.0.1:5503/login/login.html");
  }
});
...
const username = "pema@gmail.com";
const password = "password";
login.addEventListener("click", function (e) {
  e.preventDefault();

  let isInfoValid = confirm();
  if (isInfoValid) {
    window.open("http://127.0.0.1:5503/dash%20board/Dashboard.html#");
    window.close("http://127.0.0.1:5503/login/login.html");
  }
